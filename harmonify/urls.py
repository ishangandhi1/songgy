...
from harmonify import views as harmonify_views
...
urlpatterns = patterns('',
    ...
    url(r'^upload', harmonify_views.upload, name="upload"),
    url(r'^music_search', harmonify_views.song_search, name="music_search"),
    url(r'^signup/$',
